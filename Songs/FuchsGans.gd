...
var song_notes = [
	"C", "D", "E", "F", "G", "G", "G", "G", "F", "A", "C5", 
	"A", "G", "A", "F", "C5", "A", "G", "G", "F", "F", "F", "F", 
	"E", "E", "E", "E", "D", "E", "D", "C", "E", "G", "G", 
	"F", "F", "F", "F", "E", "E", "E", "E", "D", "E", "D", "C"
...
func show_congratulations():
	...
	popup.dialog_text = "🎉 Super! Du hast 'Fuchs du hast die Gans gestohlen' gespielt!"
	add_child(popup)
